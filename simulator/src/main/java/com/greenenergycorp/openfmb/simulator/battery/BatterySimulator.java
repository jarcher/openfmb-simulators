...
public class BatterySimulator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final BatteryPublisher batteryPublisher = new BatteryPublisher(mqttObserver, deviceId, openFmbXmlMarshaller, batteryReadTopic, batteryEventTopic);

        final BatteryMachine batterySimulator = new BatteryMachine(batteryPublisher, intervalMs, batterySpec);

        final PayloadObserver controlObserver = new PayloadObserver() {

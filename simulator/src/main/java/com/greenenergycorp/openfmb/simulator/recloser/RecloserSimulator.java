...
public class RecloserSimulator {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        controlHandlerMap.put(recloserControlTopic + "/" + deviceId.getLogicalDeviceId(), new RecloserSubscribers.RecloserControlSubscriber(machine, openFmbXmlMarshaller, logicalDeviceId));
        controlHandlerMap.put(batteryReadTopic + "/#", new RecloserSubscribers.BatteryReadSubscriber(machine, openFmbXmlMarshaller));
        controlHandlerMap.put(solarReadTopic + "/#", new RecloserSubscribers.SolarReadSubscriber(machine, openFmbXmlMarshaller));
        controlHandlerMap.put(resourceReadTopic + "/#", new RecloserSubscribers.ResourceReadSubscriber(machine, openFmbXmlMarshaller));
